...
file='/glade/campaign/cesm/development/cross-wg/S2S/sglanvil/forSanjiv/H2OSOI_s2sLandRunSE_perl_noCROP_1999start/s2sLandRunSE_perl_noCROP_1999start.elm.h0.199901-200202.nc';
time_ELM=datetime('Jan/1/1999'):datetime('Feb/28/2002');
...
X=H2OSOI_ERA5(:,:,year(time_ERA5)>=1999 & year(time_ERA5)<=2001);
Y=H2OSOI_ELM(:,:,year(time_ELM)>=1999 & year(time_ELM)<=2001);

%
figure
contourf(lon_ERA5,lat_ERA5,squeeze(X(:,:,33))',0:0.01:0.5,'linestyle','none');
colormap(gradsmap); colorbar; clim([0 0.5])
title('H2OSOI ELMnoCROP')
print('/glade/work/sglanvil/CCR/E3SM_SMYLE/H2OSOI_ELMnoCROP_raw','-r300','-dpng');
