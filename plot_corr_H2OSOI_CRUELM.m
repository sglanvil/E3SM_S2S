...
file='/glade/campaign/cesm/development/cross-wg/S2S/sglanvil/forSanjiv/H2OSOI_s2sLandRunSE_perl_ICRUELM/s2sLandRunSE_perl_ICRUELM.elm.h0.199901-201512.nc';
...
title('H2OSOI CRUELM')
print('/glade/work/sglanvil/CCR/E3SM_SMYLE/H2OSOI_CRUELM_raw','-r300','-dpng');
...
title('H2OSOI Correlation (CRUELM vs ERA5)')
print('/glade/work/sglanvil/CCR/E3SM_SMYLE/H2OSOI_CRUELM','-r300','-dpng');
